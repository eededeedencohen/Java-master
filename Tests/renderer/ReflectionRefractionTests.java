...
public class ReflectionRefractionTests {
    ...
    public void trianglesTransparentSphere() throws Exception {
        ...
        ImageWriter imageWriter = new ImageWriter("shadow with transparency123", 200, 200, 600, 600);
        Render render = new Render(imageWriter, scene);
    ...
    /**
     * produce a picture that integrated transparency + reflection+ partial shadow
     * @throws Exception
     */
    @Test
    public void integrationEffectTest() throws Exception {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.setDistance(1000);
        scene.setBackground(Color.BLACK);
        ...
        scene.addGeometries(List.of( //
                new Triangle(Color.BLACK, new Material(0.5, 0.5, 60,0,1), //
                        new Point3D(-150, 150, 115), new Point3D(150, 150, 135), new Point3D(75, -75, 150)), //
                new Triangle(Color.BLACK, new Material(0.5, 0.5, 60,0,1), //
                        new Point3D(-150, 150, 115), new Point3D(-70, -70, 140), new Point3D(75, -75, 150)), //
                new Sphere(new Color(java.awt.Color.BLUE), new Material(0.2, 0.2, 30, 0.6, 0), // )
        ...
        ImageWriter imageWriter = new ImageWriter("integrationEffect", 200, 200, 600, 600);
        Render render = new Render(imageWriter, scene);
